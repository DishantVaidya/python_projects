...
With a clean and simple **Tkinter GUI**, this tool helps you declutter messy folders in just one click!
...
| `filedialog` | To browse and select folders easily |
| `messagebox` | To show success/error popups |
